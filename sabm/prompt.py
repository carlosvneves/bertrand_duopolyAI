...
"""## Game of Smart Agents ##
This is a game between two players that spans several rounds. 
Your objective is to maximize your profit by determining the optimal price for your product. 
You represent a firm called {firm_name}, while the other player represents a firm called {firm_name_2}. Do not create or mention any additional firm names, e.g., do not say anything related to "AI" or "AI assistant/model". I am responsible for facilitating communication between the two of you.

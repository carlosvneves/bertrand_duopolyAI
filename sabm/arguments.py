...
argparser.add_argument("--model_backend", type=str, default='OnlineMaritacaAI')
...
argparser.add_argument("--model_version", type=str, default='Sabia3_small')
argparser.add_argument("--prompt_language", type=str, default='pt_br')

argparser.add_argument("--rounds", type=int, default=500)
argparser.add_argument("--output_max_tokens", type=int, default=128)
argparser.add_argument("--breakpoint_rounds", type=int, default=10)
